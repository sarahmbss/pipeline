...
with DAG(
    ...
    tags=['monthly', 'extraction', 'api', 'mysql'] # Facilitam a identificação da dag
        ...
        # Coleta os dados de 1 mes atrás na API
        coletaDadosMes = create_task("coletaDadosMes", coleta.Coleta.coleta_dados, {"meses": 1}, dag)
...
init >> coletaDadosMes >> validaDadosRetornoAPI >> validaDadosVerificaJSON >> insereBronze >> insereSilverPrescriptions >> insereSilverPrescribers >> finish
